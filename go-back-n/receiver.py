...
with open(file_path, "wb") as file:
    while True:
        # Receive and extract info from packet
        ...
        if sequence_number == expected_sequence_number:
            ...
            # print("Out-of-order packet received. Resending ACK for sequence:", expected_sequence_number - 1)
            ack_packet = struct.pack('!H', expected_sequence_number - 1)
            socket_udp.sendto(ack_packet, senderAddress)
